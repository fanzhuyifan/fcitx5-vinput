...
0=Control+Page_Down
  ...
  expect(std::fseek(ini.get(), 0, SEEK_SET) == 0, "rewind legacy INI fixture");
  ...
  expect(std::fseek(output.get(), 0, SEEK_SET) == 0, "rewind saved INI fixture");
