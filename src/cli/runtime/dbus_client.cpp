...
DbusClient::DbusClient() {
  ...
  sd_bus_set_method_call_timeout(bus_,
                                 static_cast<uint64_t>(vinput::runtime::kDbusCallTimeoutUsec));
}
...
bool DbusClient::IsDaemonRunning(std::string* error) {
  ...
  int r = sd_bus_call_method(bus_, "org.freedesktop.DBus", "/org/freedesktop/DBus",
                             "org.freedesktop.DBus", "NameHasOwner", &err, &reply, "s",
...
bool DbusClient::GetDaemonStatus(std::string* status, std::string* error) {
  ...
  int r = sd_bus_call_method(bus_, vinput::dbus::kBusName, vinput::dbus::kObjectPath,
                             vinput::dbus::kInterface, vinput::dbus::kMethodGetStatus, &err, &reply,
                             "");
...
bool DbusClient::GetAsrBackendState(vinput::dbus::AsrBackendState* state, std::string* error) {
  if (!bus_) {
    if (error)
      *error = "D-Bus not connected";
    return false;
  ...
  int r = sd_bus_call_method(bus_, vinput::dbus::kBusName, vinput::dbus::kObjectPath,
                             vinput::dbus::kInterface, vinput::dbus::kMethodGetAsrBackendState,
                             &err, &reply, "");
  ...
  sd_bus_message_read(reply, "sssssbb", &target_provider, &target_model, &effective_provider,
                      &effective_model, &last_error, &reload_in_progress, &has_effective_backend);
...
bool DbusClient::StartRecording(std::string* error) {
  ...
  int r = sd_bus_call_method(bus_, vinput::dbus::kBusName, vinput::dbus::kObjectPath,
                             vinput::dbus::kInterface, vinput::dbus::kMethodStartRecording, &err,
                             &reply, "");
...
bool DbusClient::StartCommandRecording(const std::string& selected_text, std::string* error) {
  ...
  int r = sd_bus_call_method(bus_, vinput::dbus::kBusName, vinput::dbus::kObjectPath,
                             vinput::dbus::kInterface, vinput::dbus::kMethodStartCommandRecording,
...
bool DbusClient::StopRecording(const std::string& scene_id, std::string* error) {
  ...
  int r = sd_bus_call_method(bus_, vinput::dbus::kBusName, vinput::dbus::kObjectPath,
                             vinput::dbus::kInterface, vinput::dbus::kMethodStopRecording, &err,
                             &reply, "s", scene_id.c_str());
...
bool DbusClient::ReloadAsrBackend(std::string* error) {
  ...
  int r = sd_bus_call_method(bus_, vinput::dbus::kBusName, vinput::dbus::kObjectPath,
                             vinput::dbus::kInterface, vinput::dbus::kMethodReloadAsrBackend, &err,
                             &reply, "");
...
bool DbusClient::StartAdapter(const std::string& adapter_id, std::string* error) {
  ...
  int r = sd_bus_call_method(bus_, vinput::dbus::kBusName, vinput::dbus::kObjectPath,
                             vinput::dbus::kInterface, vinput::dbus::kMethodStartAdapter, &err,
                             &reply, "s", adapter_id.c_str());
...
bool DbusClient::StopAdapter(const std::string& adapter_id, std::string* error) {
  ...
  int r = sd_bus_call_method(bus_, vinput::dbus::kBusName, vinput::dbus::kObjectPath,
                             vinput::dbus::kInterface, vinput::dbus::kMethodStopAdapter, &err,
                             &reply, "s", adapter_id.c_str());
...
bool DbusClient::Notify(const vinput::dbus::ErrorInfo& notification, std::string* error) {
  if (!bus_) {
    if (error)
      *error = "D-Bus not connected";
    return false;
  ...
  int r = sd_bus_call_method(bus_, vinput::dbus::kFcitxBusName, vinput::dbus::kNotifierObjectPath,
                             vinput::dbus::kNotifierInterface, vinput::dbus::kMethodNotify, &err,
                             &reply, vinput::dbus::kErrorInfoSignature, notification.code.c_str(),
                             notification.subject.c_str(), notification.detail.c_str(),
